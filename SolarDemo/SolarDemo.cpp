...
void SolarDemo::init() {
	...
	renderManager.addRenderable("parent", parent);
	renderManager.addRenderable("parentC", parentChild);
	renderManager.addRenderable("parentCC", parentChildChild);
	renderManager.addRenderable("parentCC1", parentChildChildChild1);
	renderManager.addRenderable("parentCC2", parentChildChildChild2);
